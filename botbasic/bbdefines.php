...
define('BOTBASIC_DOWNLOADDAEMON_DOWNLOADS_DIR', BOTBASIC_BASEDIR . '/media/downloads');
...
define('BOTBASIC_TELEGRAM_THUMB_MAX_SIZE_PX',       90);
define('BOTBASIC_TELEGRAM_JPEG_COMPRESSION',        75);
