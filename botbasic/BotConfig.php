...
abstract class BotConfig
{
    ...
    static private $cmMessagesBase = [
        "es" => [
            ...
            self::MSG_HINT_TEMPLATE1_FOR_DATATYPE => "Ingresa {datatype} (ej. {example}).",
        ...
        "en" => [
            ...
            self::MSG_HINT_TEMPLATE1_FOR_DATATYPE => "Enter {datatype} (ex. {example}).",
            self::MSG_HINT_TEMPLATE2_FOR_DATATYPE => "Enter {datatype}.",
