 ...
 * @package T3
 */
class Invitacion extends Persistable
{
    ...
    {
        return self::DBwriteHelper(/** @var Invitacion $obj */ $obj, [
    ...
    static public function query ($remitentes, $destinatarios, $sqlWhereAnd = null, $fieldToDerive = null, $loadWhenDeriving = true)
    {
        return self::DBquery(__CLASS__, [
                'remitente'     => $remitentes,
                'destinatario'  => $destinatarios,
            ], $sqlWhereAnd, $fieldToDerive, $loadWhenDeriving
        );
    }
